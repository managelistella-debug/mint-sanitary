  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Article */}
        <article className="py-[80px] md:py-[100px]">
          <div className="px-4 sm:px-8 md:px-[60px] max-w-[820px] mx-auto flex flex-col gap-[48px]">

            {/* Intro */}
            <div className="flex flex-col gap-[20px]">
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                Whether you tackle it yourself or bring in professionals for <strong>house cleaning in North Vancouver</strong>, here are seven high-impact ways to get your home truly ready for the season ahead.
              </p>
            </div>

            {/* Image 1 — generated: living room */}
            <figure className="flex flex-col gap-[12px]">
              ...
              <figcaption className="font-body text-[13px] text-black/40 text-center italic">
            ...
            <div className="flex flex-col gap-[14px]">
              <h2 className="font-display text-[26px] sm:text-[30px] leading-[1.2] text-[#253862] uppercase">
                1. Improve Curb Appeal
              </h2>
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                First impressions start at the curb. After months of fall leaves, winter grime, and rain-soaked debris, your driveway, walkways, and exterior surfaces need attention before anything else. Start by clearing out dead plants and last year's mulch from the flower beds, and replace them with spring annuals like pansies, daffodils, or ornamental kale — hardy options well-suited to North Vancouver's mild but unpredictable spring weather.
              </p>
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                Spring cleaning isn't a quick vacuum and a wipe of the counters. A real spring deep clean means going into the spaces that accumulate grime all winter long: behind the fridge and stove, inside kitchen cabinets, the tracks of sliding doors and windows, ceiling fans, light fixtures, and baseboards throughout. Bathrooms should be descaled thoroughly — North Vancouver's water is relatively mineral-rich, and lime buildup around faucets and showerheads can become significant over a winter.
              </p>
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                If a full deep clean feels overwhelming, that's exactly what professional <strong>house cleaning in North Vancouver</strong> services like{" "}
                <Link href="/" className="text-[#6191e9] font-semibold hover:underline">
                  Mint Sanitary
                </Link>{" "}
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                Clean windows also matter for plants — if you've been keeping indoor plants over winter, moving them into cleaner light can help them recover from the shorter days and dry indoor air of the heating season.
              </p>
            </div>

            {/* Image 3 — from website: deep cleaned kitchen */}
            <figure className="flex flex-col gap-[12px]">
              <div className="relative rounded-[14px] overflow-hidden" style={{ height: "420px" }}>
                <Image
                  src="/deep-cleaned-kitchen-north-vancouver.jpg"
                  alt="Deep cleaned kitchen in a North Vancouver home — Mint Sanitary"
                  fill
                  sizes="(max-width: 820px) 100vw, 820px"
                  className="object-cover"
                />
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                Spring is the best time to take stock of what you've accumulated over the past year. Work through closets, storage areas, and the garage with three categories: keep, donate, and discard. In North Vancouver, you can drop usable goods at local organizations like the Harvest Project or Thrift for the North Shore. Electronics and hazardous household waste can be dropped off at the RCBC depot on Mountain Highway.
              </p>
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                Carpets, rugs, upholstery, drapes, and pillows absorb a winter's worth of dust, pet dander, and moisture. Spring is the ideal time to have carpets and area rugs professionally cleaned — the weather is dry enough for quick drying, and you'll notice the difference immediately in how fresh the home smells. Throw your duvets, decorative pillows, and machine-washable curtains through the wash. If your drapes or upholstery aren't machine-washable, a professional upholstery cleaning service can restore them safely.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
                North Vancouver receives some of the highest rainfall in Metro Vancouver, and gutters work hard all winter. Spring is the right moment to clear out any debris, check for sagging sections, and inspect downspout drainage to make sure water is being directed away from your foundation. While you're up there, scan the roof for missing or lifted shingles and check around vents and flashings for any gaps that could allow moisture in.
              </p>
              <p className="font-body text-[17px] leading-[1.75] text-black/75">
            ...
            {/* Image 4 — from website: eco-friendly cleaning */}
            <figure className="flex flex-col gap-[12px]">
              <div className="relative rounded-[14px] overflow-hidden" style={{ height: "420px" }}>
                <Image
            ...
            {/* CTA block */}
            <div className="rounded-[16px] bg-[#f0f5ff] border border-[#c8d9f7] p-[36px] sm:p-[48px] flex flex-col gap-[18px] items-start">
              <p className="font-body font-extrabold text-[12px] tracking-[1.0px] uppercase text-[#6191e9]">
                Ready to get started?
              </p>
              <h3 className="font-display text-[24px] sm:text-[30px] leading-[1.2] text-[#253862] uppercase">
                Let Mint Handle the Heavy Lifting
              </h3>
              <p className="font-body text-[16px] leading-[1.7] text-black/65">
                Spring cleaning is a big job — especially when you're doing it right. The team at{" "}
                <Link href="/" className="text-[#6191e9] font-semibold hover:underline">
                  Mint Sanitary
                </Link>{" "}
                provides thorough, eco-friendly <strong>house cleaning in North Vancouver</strong> for homes of all sizes. Whether you need a one-time spring deep clean, a carpet refresh, or a recurring maintenance schedule, we're here seven days a week to make your home feel its absolute best.
              </p>
              <div className="flex flex-col sm:flex-row gap-[12px] mt-[4px]">
                <a
                  href="/contact"
                  className="inline-flex items-center justify-center bg-[#253862] text-white font-body font-extrabold text-[14px] tracking-[0.32px] uppercase rounded-[99px] px-[32px] py-[12px] hover:bg-[#6191e9] transition-colors duration-200"
                >
                  Get a Free Estimate
                </a>
                <a
                  href="tel:+12366883248"
                  className="inline-flex items-center justify-center border-2 border-[#253862]/30 text-[#253862] font-body font-extrabold text-[14px] tracking-[0.32px] uppercase rounded-[99px] px-[32px] py-[12px] hover:border-[#253862] transition-colors duration-200"
                >
                  Call 236-688-3248
                </a>
              </div>
            ...
            <div className="pt-[8px]">
              <Link
                href="/blog"
                className="font-body font-extrabold text-[13px] tracking-[0.32px] uppercase text-[#6191e9] hover:text-[#253862] transition-colors"
              >
                ← Back to Blog
              </Link>
            </div>
