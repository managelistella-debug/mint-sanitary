          ...
          <div className="px-4 sm:px-8 md:px-[60px] max-w-[820px] mx-auto flex flex-col gap-[48px]">
            ...
            <div className="rounded-[16px] bg-white/6 border border-white/12 p-[36px] sm:p-[48px] flex flex-col gap-[18px] items-start">
              ...
              <p className="font-body text-[16px] leading-[1.7] text-white/65">
                <Link href="/" className="text-[#93b8f5] font-semibold hover:text-white transition-colors">Mint Sanitary</Link> provides <Link href="/north-vancouver/pressure-washing#driveway-pressure-washing" className="text-[#93b8f5] hover:text-white transition-colors">driveway washing</Link>, <Link href="/north-vancouver/pressure-washing#deck-patio-cleaning" className="text-[#93b8f5] hover:text-white transition-colors">deck and patio cleaning</Link>, <Link href="/north-vancouver/pressure-washing#house-washing" className="text-[#93b8f5] hover:text-white transition-colors">house washing</Link>, and <Link href="/north-vancouver/pressure-washing#fence-washing" className="text-[#93b8f5] hover:text-white transition-colors">fence washing</Link> across North Vancouver and the North Shore. We adjust pressure and technique to each surface and use eco-friendly treatments to kill biological growth at the root. Free estimates, available seven days a week.
              </p>
