...
const faqItems = [
  {
    question: "What does commercial cleaning include in North Vancouver?",
    answer:
      "Commercial cleaning covers floors, carpets, washrooms, break rooms, desks, common areas, windows, and disposal systems. The exact scope varies by business type and size. We customize every plan for your North Vancouver location during a free walkthrough estimate.",
  },
  {
    question: "How often should a North Vancouver commercial space be cleaned?",
    answer:
      "Most North Vancouver offices need daily or weekly service depending on foot traffic. Retail spaces benefit from daily attention. Restaurants typically need nightly deep cleans. We recommend a schedule during your estimate based on your specific situation.",
  },
  {
    question: "Do you use eco-friendly products for commercial spaces in North Vancouver?",
    answer:
      "Yes. All of our products are eco-friendly and non-toxic. They perform as well as harsh chemicals without the toxins that harm indoor air quality and employee health. Safety data sheets are available on request for any North Vancouver business.",
  },
  {
    question: "Can you clean around our North Vancouver business's operating hours?",
    answer:
      "Absolutely. We offer early morning, evening, late night, and weekend service that works around your business schedule. Most North Vancouver clients prefer after-hours cleaning so there's zero disruption.",
  },
  {
  ...
  {
    question: "Are your North Vancouver commercial cleaners trained and insured?",
    answer:
      "Every team member is professionally trained, fully insured, bonded, and police-checked. We also maintain WorkSafeBC coverage and current WHMIS certification for all work performed in North Vancouver.",
  },
  {
    question: "What's the difference between janitorial and commercial cleaning in North Vancouver?",
    answer:
      "Janitorial service handles routine daily maintenance like emptying bins and restocking supplies. Commercial cleaning goes deeper with floor stripping, window cleaning, deep disinfection, and specialized work. Most North Vancouver clients need both.",
  },
  {
    question: "Do you serve strata buildings and condominiums in North Vancouver?",
    answer:
  ...
  {
    question: "Do you offer one-time deep cleaning for North Vancouver commercial spaces?",
    answer:
      "Yes. In addition to recurring contracts, we provide one-time deep cleaning for move-ins, move-outs, post-renovation cleanup, and special events in North Vancouver. Call for a free estimate.",
  },
  {
    question: "What sets Mint Sanitary apart from other commercial cleaners in North Vancouver?",
    answer:
      "We combine 7-day availability, eco-friendly products, WorkSafeBC and WHMIS compliance, transparent pricing, month-to-month flexibility, and a 24-hour satisfaction guarantee. We treat every North Vancouver facility like our own.",
  },
  {
    question:
      "Do you clean commercial spaces in Lower Lonsdale and other North Vancouver business districts?",
    answer:
      "Yes. We regularly clean offices and retail spaces throughout Lower Lonsdale, along with businesses further up the hill in Lynn Valley and Edgemont Village.",
  },
  {
    question:
      "Can strata councils in North Vancouver set up a recurring commercial cleaning contract?",
    answer:
      "Yes. Many strata councils in North Vancouver choose a weekly or bi-weekly schedule for common areas, with a month-to-month contract that can adjust as the building's needs change.",
  },
  {
    question: "Do you clean medical and dental offices in North Vancouver?",
    answer:
      "Yes. Medical and dental offices need a higher standard of disinfection than a typical office. Our North Vancouver team follows Health Canada guidelines for high-touch surfaces and can build a schedule around patient hours.",
  },
  {
    question: "What safety measures do your North Vancouver commercial cleaners follow?",
    answer:
      "Our team is trained in WorkSafeBC workplace safety standards and current WHMIS chemical handling protocols. Every cleaner working in North Vancouver carries proper coverage before stepping onto a client's property.",
  },
  {
    question: "Can I get a customized cleaning checklist for my North Vancouver business?",
    answer:
      "Yes. During your free walkthrough, we build a checklist specific to your North Vancouver space, covering everything from daily desk wipe-downs to monthly deep cleaning tasks.",
  },
  {
    question: "Do you clean retail stores in North Vancouver?",
    answer:
      "Yes. Retail spaces in North Vancouver, from Lower Lonsdale storefronts to shops near Edgemont Village, typically benefit from daily or near-daily cleaning to stay presentable for customers.",
  },
  {
    question: "What types of North Vancouver businesses do you work with?",
    answer:
      "We clean offices, commercial kitchens, strata buildings, schools, gyms, and churches across North Vancouver, and have worked with organizations including Vancouver Coastal Health, BC Hydro, Arbutus Point Developments Ltd., and Powers Construction.",
  },
  {
    question: "Do you clean office buildings near Deep Cove and Seymour Heights?",
    answer:
      "Yes. We cover all of North Vancouver, including smaller commercial spaces out toward Deep Cove and the Seymour Heights area, on the same flexible scheduling options available closer to downtown North Vancouver.",
  },
];
          ...
          <div className="relative z-10 mx-auto grid max-w-[1200px] grid-cols-1 items-center px-4 pb-32 pt-[180px] sm:px-8 md:grid-cols-2 md:px-[60px] md:pb-40 md:pt-[200px]">
            <div>
              ...
              <p className="mt-6 max-w-[540px] font-body text-[17px] leading-[1.75] text-white/90">
                ...
                pricing. We work with businesses from Lower Lonsdale&apos;s
                waterfront offices to properties further up the hill in
                Edgemont Village and Seymour Heights.
              </p>
            ...
            <div className="mt-8 grid gap-10 md:grid-cols-2 md:gap-12">
              ...
              <div>
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  ...
                  facility&apos;s unique needs. That includes everything from
                  small offices in Lynn Valley to multi-unit strata buildings
            ...
            <div>
              ...
              <div className="mt-6 space-y-5">
                ...
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  ...
                  equipment, and confidential areas. This holds whether the
                  property sits in a busy commercial strip in Lower Lonsdale or
                  a quieter business park near Deep Cove.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
