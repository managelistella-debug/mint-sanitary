...
const services = [
  {
    ...
    description:
      "Hand removal of leaves, twigs, pine needles, moss, shingle granules, dirt, and organic buildup. North Vancouver's dense tree cover means fine particles build up fast too, so vacuum equipment catches what hand removal can't.",
  },
  {
    title: "Downspout Flushing",
    description:
      "High pressure flushing confirms every downspout is fully clear and routing water away from the foundation.",
  },
  {
    title: "System Inspection",
    description:
      "Technician checks loose brackets, missing hardware, rust spots, seam leaks, and pitch problems, with before and after photo documentation on every visit.",
  },
  {
    title: "Gutter Guard Evaluation",
    description:
      "Plenty of homes, especially in treed pockets like Edgemont Village and Seymour Heights, already have guards installed. We clean and evaluate them for damage.",
  },
  {
    title: "Environmentally Responsible Disposal",
    description:
      "Debris bagged and hauled away following Metro Vancouver stormwater rules, never dumped in the yard or a storm drain.",
  },
];
          ...
          <div className="relative z-10 mx-auto grid max-w-[1200px] grid-cols-1 items-center px-4 pb-32 pt-[180px] sm:px-8 md:grid-cols-2 md:px-[60px] md:pb-40 md:pt-[200px]">
            <div>
              ...
              <p className="mt-6 max-w-[520px] font-body text-[17px] leading-[1.75] text-white/90">
                North Vancouver homes sit at the base of the North Shore
                mountains, in one of the wettest climates in Canada.
                Gutters are the first line of defense against that rain,
                moving water off the roof and away from siding, fascia,
                and the foundation. When they clog with leaves, needles,
                and moss, that protection disappears, and clogged gutters
                cause expensive damage fast, from rotted fascia boards to
                soaked basements. Mint Sanitary provides professional
                gutter cleaning for homes throughout North Vancouver, from
                Lower Lonsdale to Lynn Valley to Deep Cove, with hand
                debris removal, downspout flushing, and a full inspection
                on every visit.
              </p>
            ...
            <div>
              ...
              <div className="mt-6 space-y-5">
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  North Vancouver gets roughly 2,400mm of rain a year,
                  more than two and a half times the North American
                  average of about 900mm, concentrated between October
                  and March. Standing water in a clogged gutter works
                  into fascia boards, soffits, siding, and eventually the
                  foundation, and repairs for that kind of infiltration
                  commonly run $3,000 to $25,000. Homes on sloped lots in
                  areas like Upper Lonsdale and Capilano see this play
                  out fast, since overflow often runs straight down a
                  hillside foundation.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  A single residential gutter here can collect more than
                  50 pounds of leaves, twigs, needles, and granules in
                  the fall alone. Streets in Lynn Valley and around
                  Dollarton back onto forested slopes and see the
                  heaviest debris load in the district.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  More than a few North Vancouver rooflines end up with
                  the gutter itself invisible under a mat of wet needles
                  and moss, holding water against the metal for months.
                  It isn&apos;t rare here. The wet, mild climate and
                  heavy tree shade create close to ideal moss growing
                  conditions, and moss blocks water flow while trapping
                  moisture that speeds up rust and seam failure.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/80">
                  Homeowner&apos;s insurance usually doesn&apos;t cover
                  gutter maintenance, and neglect-related water damage
                  may be excluded from a claim entirely. For many North
                  Vancouver homeowners, a twice yearly cleaning is
                  cheaper than a single deductible.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[1200px]">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-[700px] font-body text-[15px] leading-[1.7] text-white/80">
                Homes in North Vancouver deal with more leaf litter,
                moss, and standing water than most of the region, so
                every visit here covers the full system from the
                roofline down to the downspout outlet.
              </p>
            </div>
