        ...
        <div className="flex flex-col gap-[46px] items-center px-4 sm:px-8 md:px-[60px]">
          ...
          <div className="reveal grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[16px] md:gap-[25px] w-full">
            {areas.map((area) => (
              ...
              >
                <span className="font-display-reg text-[18px] sm:text-[20px] md:text-[24px] tracking-[0.96px] uppercase text-[#0a2540] group-hover:text-white transition-colors duration-300 leading-none text-center">
                  {area}
                </span>
              </div>
            ))}
